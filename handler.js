...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'ʙy Claraa'
        global.kontak2 = [
        ['62895604670507', 'Claraa', 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'clarz939@gmail.com', true],
        ['6281905091832', 'Evil-𝙱𝙾𝚃', 'Bot WhatsApp', 'Nothing!', true],
        ['6281905091832', 'Evil-𝙱𝙾𝚃', 'Bot WhatsApp', 'Nothing!', true],
        ['6281905091832', 'Evil-𝙱𝙾𝚃', 'Bot WhatsApp', 'Nothing!', true],
        ['6281905091832', 'Evil-𝙱𝙾𝚃', 'Bot WhatsApp', 'Nothing!', true],
        ['6281905091832', 'Evil-𝙱𝙾𝚃', 'Bot WhatsApp', 'Nothing!', true],
   ...
   await conn.sendButtonDoc(id, text, wm, action == 'add' ? 'selamat datang' : 'sampai jumpa', action === 'add' ? '.intro' : 'EvilBOT-MD', fkontak,{
...
global.dfail = async (type, m, conn) => {
    ...
    let msg = {
        rowner: 'Perintah ini hanya dapat digunakan oleh _*Claraa!1!1!*_',
        owner: 'Perintah ini hanya dapat digunakan oleh _*Claraaa!1!1!*_',
